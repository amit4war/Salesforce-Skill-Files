...
| Naming, Flow, bypass mechanism, project standards, metadata, any new artifact            | `skills/configuration-patterns/SKILL.md`    |
| OmniScript, DataRaptor, Integration Procedure, FlexCard, OmniStudio                      | `skills/omni-studio-patterns/SKILL.md`      |
| REST callout, SOAP callout, Platform Event, Change Data Capture, Named Credential, OAuth | `skills/integration-patterns/SKILL.md`      |
